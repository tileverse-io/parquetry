...
/**
 * Column vector for INT96 (deprecated 12-byte timestamp) values. Each cell is a 12-byte {@link MemorySegment} view;
...
public final class Int96Vector implements ColumnVector {
    ...
    private Int96Vector(@NonNull MemorySegment[] values, @NonNull BitSet validity) {
        this.values = values;
        this.validity = validity;
    }

    public static Int96Vector materialized(@NonNull MemorySegment[] values, @NonNull BitSet validity) {
        return new Int96Vector(values, validity);
    }
