...
| `parquetry-geo-jts` | Read GeoParquet geometries straight from a `MemorySegment` WKB into JTS | `parquetry-core` |
...
| `parquetry-geotools` | A GeoTools `DataStore` reading GeoParquet | `parquetry-core`, `parquetry-catalog`, `parquetry-geo-jts`, `parquetry-tileverse-storage` |
