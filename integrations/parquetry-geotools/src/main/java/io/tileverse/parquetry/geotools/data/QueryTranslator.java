 ...
 * {@link PushdownFilterCapabilities}; then {@link FilterToPredicate} translates the pre-part exactly, returning its own
 * residual for anything it cannot express. The two residuals combine into the post-filter.
 */
