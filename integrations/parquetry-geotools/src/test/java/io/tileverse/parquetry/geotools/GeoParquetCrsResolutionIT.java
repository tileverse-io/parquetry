 ...
 * {@link GeoParquetSchemaMapper} and asserts the GeoTools CRS that lands on the geometry attribute. The reader-level
 * CRS identity parsing lives in {@code parquetry-core}; this is the GeoTools adapter's registry resolution of the same
 * fixtures.
 *
