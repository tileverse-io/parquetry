 ...
 *
 * <p>Inverse of {@link io.tileverse.parquetry.data.read.page.ByteStreamSplitDoubleDecoder}. For {@code n} eight-byte
 * values the output is laid out as eight streams of {@code n} bytes each: byte 0 of every value, then byte 1, ..., byte
 * 7.
 */
