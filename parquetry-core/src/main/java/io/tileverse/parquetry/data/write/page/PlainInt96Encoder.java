 ...
 *
 * <p>Inverse of {@link io.tileverse.parquetry.data.read.page.PlainInt96Decoder}. INT96 is a deprecated legacy timestamp
 * type; each value is written as 12 raw bytes (whose internal layout is up to the caller; the decoder also yields raw
 * bytes).
 */
