 ...
 * entry (the column reads as a real null); a value of an unexpected shape fails fast.
 */
final class IcebergPartitionValues {
    ...
    private static void addIdentityConstant(
        ...
        constants.put(
                partitionField.sourceFieldId(), IcebergScalarValues.fromPartition(source.type(), raw, source.name()));
    }
}
