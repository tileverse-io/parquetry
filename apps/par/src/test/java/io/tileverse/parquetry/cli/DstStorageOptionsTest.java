...
class DstStorageOptionsTest {
    ...
    void allFlagsMapToExpectedStorageKeys() {
        ...
        assertThat(props)
                ...
                .containsEntry("storage.s3.endpoint", "http://h:1")
                .containsEntry("storage.gcs.endpoint", "http://h:1")
                .containsEntry("storage.azure.endpoint", "http://h:1")
                .hasSize(10);
    }
