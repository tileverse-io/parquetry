 ...
 *
 * <p>Inverse of {@link io.tileverse.parquetry.data.read.page.RleBooleanDecoder}. The length-prefix convention is the
 * same one Parquet uses for V1 RLE-encoded data pages.
 */
