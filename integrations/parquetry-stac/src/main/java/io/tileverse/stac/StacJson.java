...
/**
 * Reads STAC JSON documents into a Jackson tree. Holds the one {@link JsonMapper} the STAC reader uses, keeping the
 * model package free of any parquetry JSON helper.
 */
