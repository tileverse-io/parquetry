 ...
 *
 * <p>Inverse of {@link io.tileverse.parquetry.data.read.page.PlainFixedLenBinaryDecoder}. The fixed width comes from
 * the schema's {@code typeLength}; every value passed to {@link #encode} must match it exactly.
 */
