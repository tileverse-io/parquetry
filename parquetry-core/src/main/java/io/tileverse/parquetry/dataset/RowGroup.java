 ...
 * encryption, etc.) through {@code ParquetDataset}. Callers needing the full thrift view can call
 ...
 */
public record RowGroup(int index, long rowCount, long totalByteSize, long totalCompressedSize) {}
