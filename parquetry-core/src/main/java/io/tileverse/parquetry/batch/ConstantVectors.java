...
public final class ConstantVectors {
     ...
     * constant column, reserved for null-column injection (a field absent from a file under schema evolution, or a
     * typed-null partition). Not yet wired by the catalog; kept as the forward hook a future schema-evolution / Iceberg
     * field-id read path reuses.
     */
