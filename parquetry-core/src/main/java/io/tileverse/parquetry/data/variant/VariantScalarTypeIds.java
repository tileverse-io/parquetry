...
final class VariantScalarTypeIds {

    static final int TYPE_BOOLEAN_TRUE = 1;
    static final int TYPE_BOOLEAN_FALSE = 2;
    ...
    static final int TYPE_TIMESTAMP_TZ_MICROS = 12;
    static final int TYPE_TIMESTAMP_NTZ_MICROS = 13;
    ...
    static final int TYPE_TIMESTAMP_TZ_NANOS = 18;
    static final int TYPE_TIMESTAMP_NTZ_NANOS = 19;
